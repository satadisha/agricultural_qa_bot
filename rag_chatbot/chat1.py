...
LORA_ADAPTER = "MarsGray/Phi-4-mini-instruct-lora-model"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Chat with memory using LoRA fine-tuned Phi model")
...
# python chat1.py --country albania --db_path processed/chroma_db
